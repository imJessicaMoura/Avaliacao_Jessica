...
namespace WebApp_Desafio_FrontEnd.ApiClients.Desafio_API
{
    public class DepartamentosApiClient : BaseClient
    {
        ...
        private const string departamentosObterUrl = "api/Departamentos/ObterDepartamento";
        private const string departamentosGravarUrl = "api/Departamentos/GravarDepartamento";
        private const string departamentosExcluirUrl = "api/Departamentos/ExcluirDepartamento";

        private string desafioApiUrl = "https://localhost:5001/"; // Endereço API IIS-Express
